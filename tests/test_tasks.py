...
class TasksTests(unittest.TestCase):
    ...
    def test_username_displays_on_tasks_page(self):

        self.create_user('Michael Michealowitsh', 'michael@realpython.com', 'python')
        self.login('Michael Michealowitsh', 'python')
        response = self.app.get('tasks/', follow_redirects=True)
        self.assertIn(b'Michael Michealowitsh', response.data)


    def test_mark_as_complete_displays_to_current_user(self):
    ...
    def test_mark_as_complete_doesnt_display_to_another_user(self):
        ...
        self.create_user('New User', 'new@user.com', 'python')
        self.login('New User', 'python')
        response = self.app.get('tasks/', follow_redirects=True)
        self.assertNotIn(b'/complete/1', response.data)


    def test_mark_as_complete_displays_to_admin(self):
    ...
    def test_delete_displays_to_current_user(self):
    ...
    def test_delete_doesnt_display_to_another_user(self):
        ...
        self.create_task()
        self.create_task()
        self.app.get("complete/2/", follow_redirects=True)
        self.logout()
    ...
    def test_delete_displays_to_admin(self):
